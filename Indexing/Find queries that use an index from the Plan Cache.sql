-- Find queries using an index from the Plan Cache
-- Part of the SQL Server DBA Toolbox at https://github.com/DavidSchanzer/Sql-Server-DBA-Toolbox
-- This script searches plans in the Plan Cache for a specific index
...
WHERE textplan.query_plan LIKE '%<IndexName>%'
      AND SUBSTRING(
                       sqltext.text,
                       (querystats.statement_start_offset / 2) + 1,
                       (CASE querystats.statement_end_offset
