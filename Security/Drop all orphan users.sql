USE [master];
GO
CREATE PROC dbo.Drop_OrphanedUsers
AS
    BEGIN
        SET NOCOUNT ON;
        ...
        DECLARE c_orphaned_user CURSOR LOCAL FAST_FORWARD
        FOR
            SELECT  name
        ...
        BEGIN
            ...
            DECLARE c_schema CURSOR LOCAL FAST_FORWARD
            FOR
                SELECT  name
                FROM    sys.schemas
            ...
            DECLARE c_database_principal CURSOR LOCAL FAST_FORWARD
            FOR
                SELECT  name
                FROM    sys.database_principals
                WHERE   type = 'R'
            ...
            DECLARE c_role CURSOR LOCAL FAST_FORWARD
            FOR
